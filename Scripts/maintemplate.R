...
loadconfig("clare_SDH_DDH_Excit_Inhib")
...
ggsave("../Output/Clare mouse/mouse_fdp_zsoflog1pCPMnolabs_example.png",
       plot = gain, height = 3200, width = 13600, device = "png",
       units = "px", dpi = 300, type = "cairo")

# Then without labels on y alone
gain <- mainDP(lbc, saveimage = F, rm.labs = "y", transp = T)
ggsave("../Output/Jessica/mouse_fdp_zsoflog1pCPMnolabs_example.png",
       plot = gain, height = 3200, width = 13600, device = "png",
...
mainPDP(CPR, base.name = "PDP_SDHvDDH", height = 2200,
        ...
        transp = F, max.dot.size = 20, yieldplot = T,
...
ggsave("../Output/Clare mouse/mouse_PDP_SDHvDDH_zsoflog1pCPM.png",
       plot = power, height = 5000, width = 4400, device = "png", units = "px",
       dpi = 600, type = "cairo")
# Without labels
mainPDP(CPR, base.name = "PDP_SDHvDDH", height = 2200,
        width = 2750, factor.order = unlist(user_order[["2"]]),
...
loadconfig("clare_human_DH_Excit_Inhib")
...
# Looking at somatic expression
unique(RDfile@meta.data$new_annotation)
